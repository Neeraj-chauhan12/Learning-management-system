        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <div className="mx-auto max-w-7xl">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                <div className="text-white">
                  <p className="text-sm font-semibold uppercase tracking-[0.3em] opacity-90">Welcome back</p>
                  <h1 className="mt-2 text-4xl sm:text-5xl font-bold">
                    Hey, {data?.user?.username}!
                  </h1>
                  <p className="mt-3 text-lg text-white/80 max-w-2xl">
                    Manage your courses, track student progress, and grow your teaching presence.
                  </p>
                </div>
                <Link
                  to="/create"
              ...
              <div className="rounded-2xl bg-white p-6 shadow-lg shadow-slate-900/5 border-l-4 border-indigo-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-3xl font-bold text-slate-950">{courses.length}</p>
                  </div>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-lg shadow-slate-900/5 border-l-4 border-emerald-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-3xl font-bold text-slate-950">{publishedCourses.length}</p>
                  </div>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-lg shadow-slate-900/5 border-l-4 border-cyan-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-3xl font-bold text-slate-950">{totalEnrolled}</p>
                  </div>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-lg shadow-slate-900/5 border-l-4 border-amber-500">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-3xl font-bold text-slate-950">{unpublishedCourses.length}</p>
                  </div>
            ...
            <div className="rounded-2xl bg-white p-8 shadow-lg shadow-slate-900/5">
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                ...
                >
                  ...
                  <p className="text-sm text-white/75 mt-1">Start teaching your expertise</p>
                </Link>
                <Link
                  to="/dashboard"
                ...
                >
                  ...
                  <p className="text-sm text-slate-600 mt-1">Manage all your courses</p>
                </Link>
                <Link
                  to="/profile"
                  className="rounded-xl border-2 border-slate-200 p-6 text-slate-950 transition hover:bg-slate-50 group"
                >
                  ...
                  <p className="text-sm text-slate-600 mt-1">Update your information</p>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 pb-12">
            <div className="mb-8">
              ...
              <p className="text-slate-600">Manage and edit your published and draft courses</p>
            </div>
            ...
            {coursesLoading ? (
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {courses.slice(0, 3).map((course) => (
                  <div key={course._id} className="group rounded-2xl bg-white overflow-hidden shadow-lg hover:shadow-xl transition">
                    <div className="relative overflow-hidden bg-gradient-to-br from-indigo-500 to-cyan-500 h-40">
                      <img
                        src={course.courseThumbnail || "https://img.daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.webp"}
                    ...
                    <div className="p-5">
                      <h3 className="font-semibold text-slate-950 line-clamp-2">{course.courseTitle}</h3>
                      <p className="text-sm text-slate-600 mt-1 line-clamp-1">{course.category}</p>
                      <div className="mt-4 flex items-center justify-between text-sm">
                        <span className="text-slate-600">{course.enrolledStudents?.length || 0} students</span>
                        <span className="font-semibold text-indigo-600">₹{course.coursePrice || 0}</span>
                      </div>
                      <Link
                        to={`/edit/${course._id}`}
              ...
              <div className="rounded-2xl bg-white p-12 text-center shadow-lg">
                ...
                <p className="text-slate-500 mt-2">Start by creating your first course</p>
                <Link
                  to="/create"
