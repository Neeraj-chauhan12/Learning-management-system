                            ...
                            <ul className='list-disc  mt-2'>
                                {[1, 2, 3, 5, 6].map((idx) => (
                                    <div key={idx} className='flex items-center gap-2'>
                                        <span>{false ? <FaRegPlayCircle /> : <FaLock />}</span> <h1>Introduction to Topic</h1>
                                    </div>
                                ))
                                }
                            </ul>
                        ...
                        <div className="card bg-base-100 w-96 shadow-sm">
                            ...
                            <div className="card-body">
                                ...
                                <div className="card-actions justify-center">
                                    {
                                       isPurchased? <button className="btn w-full bg-green-500 btn-primary">Continue</button>:<PurchaseButton />
                                    }
